...
const Table = (props) => {
    const { components, columns: propsColumns2, defaults: propsDefaults = {}, onColumnMoved, onColumnResized, onColumnVisible, onColumnFixed, onColumnChange, onChange, onResetColumnSettings, ...rest } = props;
